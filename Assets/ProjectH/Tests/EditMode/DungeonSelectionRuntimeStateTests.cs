...
namespace ProjectH.Tests // 프로젝트 테스트 영역
{
    public sealed class DungeonSelectionRuntimeStateTests // 26일차 던전 선택 상태 테스트
    {
        ...
        {
            CollectionAssert.AreEqual(new[] { "DG001", "DG002", "DG003", "DG004", "DG005", "DG006", "DG007", "DG008", "DG009", "DG010", "DG011", "DG012", "DG013", "DG014", "DG015", "DG016", "DG017" }, DungeonSelectionRuntimeState.SupportedDungeonIds); // 지원 던전 ID 순서 검증 (Day65~67 지역 확장 · Day71 최종 던전)
        }
