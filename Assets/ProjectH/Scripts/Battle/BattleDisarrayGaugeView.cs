...
namespace ProjectH.Battle // 프로젝트 전투 영역
{
    ...
    public sealed class BattleDisarrayGaugeView : MonoBehaviour // 흐트러짐 게이지 표시 뷰 (Day53 신규, 런타임 생성 전용)
    {
        ...
        private static Text CreateLabel(Transform parent, string name, int fontSize, Color color) // 흐트러짐 상태 문구 텍스트 생성
        {
            ...
            outline.effectColor = new Color(0.02f, 0.04f, 0.08f, 0.85f); // 어두운 외곽선 색상 적용
