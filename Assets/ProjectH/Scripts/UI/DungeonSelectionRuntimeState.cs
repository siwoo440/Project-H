...
namespace ProjectH.UI // 프로젝트 UI 영역
{
    ...
    {
        private static readonly string[] DungeonIds = { "DG001", "DG002", "DG003", "DG004", "DG005", "DG006", "DG007", "DG008", "DG009", "DG010", "DG011", "DG012", "DG013", "DG014", "DG015", "DG016", "DG017" }; // 지원 던전 ID 목록 (Day65~67 지역 확장 · Day71 최종 던전 무명의 옥좌 추가)
